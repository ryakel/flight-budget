...
- Manual tags: Specific version (e.g., `v1.5.0`)

### 2. Docker Builder (Develop)
...
**Tags Produced**:
- `develop` branch: `develop` (always overwrites)
...
**Documentation**: [DOCKER_BUILD_SETUP.md](DOCKER_BUILD_SETUP.md), [BRANCH_STRATEGY.md](BRANCH_STRATEGY.md)
